...
import com.creatormc.judgementdaymod.eventHandlers.NetworkHandler;
...
public class JudgementDayMod {
    ...
    public static final RegistryObject<Codec<ApocalypseChunkGenerator>> APOCALYPSE_WORLD =
            CHUNK_GENERATORS.register("apocalypse", () -> ApocalypseChunkGenerator.CODEC);
}
